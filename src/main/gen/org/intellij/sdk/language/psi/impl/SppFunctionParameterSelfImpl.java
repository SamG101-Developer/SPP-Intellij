...
public class SppFunctionParameterSelfImpl extends ASTWrapperPsiElement implements SppFunctionParameterSelf {

  public SppFunctionParameterSelfImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitFunctionParameterSelf(this);
  }
