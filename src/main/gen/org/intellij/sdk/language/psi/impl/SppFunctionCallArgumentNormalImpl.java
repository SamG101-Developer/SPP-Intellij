...
public class SppFunctionCallArgumentNormalImpl extends ASTWrapperPsiElement implements SppFunctionCallArgumentNormal {

  public SppFunctionCallArgumentNormalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitFunctionCallArgumentNormal(this);
  }
