...
public class SppFunctionParameterOptionalImpl extends ASTWrapperPsiElement implements SppFunctionParameterOptional {

  public SppFunctionParameterOptionalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitFunctionParameterOptional(this);
  }
