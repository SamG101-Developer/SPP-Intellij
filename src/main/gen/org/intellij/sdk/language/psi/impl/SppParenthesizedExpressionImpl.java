...
public class SppParenthesizedExpressionImpl extends ASTWrapperPsiElement implements SppParenthesizedExpression {

  public SppParenthesizedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
