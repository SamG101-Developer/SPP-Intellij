...
public class SppWhileExpressionImpl extends ASTWrapperPsiElement implements SppWhileExpression {

  public SppWhileExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SppWhileElseExpression getWhileElseExpression() {
    return findChildByClass(SppWhileElseExpression.class);
  }
