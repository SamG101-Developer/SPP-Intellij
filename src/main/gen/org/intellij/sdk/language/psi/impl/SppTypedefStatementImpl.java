...
public class SppTypedefStatementImpl extends ASTWrapperPsiElement implements SppTypedefStatement {

  public SppTypedefStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SppTypedefItem getTypedefItem() {
    return findNotNullChildByClass(SppTypedefItem.class);
  }
