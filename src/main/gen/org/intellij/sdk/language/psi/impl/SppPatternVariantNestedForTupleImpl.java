...
public class SppPatternVariantNestedForTupleImpl extends ASTWrapperPsiElement implements SppPatternVariantNestedForTuple {

  public SppPatternVariantNestedForTupleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitPatternVariantNestedForTuple(this);
  }
