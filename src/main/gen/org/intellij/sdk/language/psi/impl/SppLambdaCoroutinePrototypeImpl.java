...
public class SppLambdaCoroutinePrototypeImpl extends ASTWrapperPsiElement implements SppLambdaCoroutinePrototype {

  public SppLambdaCoroutinePrototypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitLambdaCoroutinePrototype(this);
  }
