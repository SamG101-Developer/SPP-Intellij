...
public class SppLetStatementInitializedImpl extends ASTWrapperPsiElement implements SppLetStatementInitialized {

  public SppLetStatementInitializedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitLetStatementInitialized(this);
  }
