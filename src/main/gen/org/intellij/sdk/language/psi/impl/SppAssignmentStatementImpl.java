...
public class SppAssignmentStatementImpl extends ASTWrapperPsiElement implements SppAssignmentStatement {

  public SppAssignmentStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
