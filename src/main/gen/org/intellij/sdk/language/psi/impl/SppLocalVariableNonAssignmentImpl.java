...
public class SppLocalVariableNonAssignmentImpl extends ASTWrapperPsiElement implements SppLocalVariableNonAssignment {

  public SppLocalVariableNonAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitLocalVariableNonAssignment(this);
  }
