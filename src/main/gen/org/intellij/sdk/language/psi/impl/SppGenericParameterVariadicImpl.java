...
public class SppGenericParameterVariadicImpl extends ASTWrapperPsiElement implements SppGenericParameterVariadic {

  public SppGenericParameterVariadicImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitGenericParameterVariadic(this);
  }
