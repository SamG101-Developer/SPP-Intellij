...
public class SppWithExpressionLhsAliasImpl extends ASTWrapperPsiElement implements SppWithExpressionLhsAlias {

  public SppWithExpressionLhsAliasImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitWithExpressionLhsAlias(this);
  }
