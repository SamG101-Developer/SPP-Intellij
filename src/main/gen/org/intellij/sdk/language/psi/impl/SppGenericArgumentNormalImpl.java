...
public class SppGenericArgumentNormalImpl extends ASTWrapperPsiElement implements SppGenericArgumentNormal {

  public SppGenericArgumentNormalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitGenericArgumentNormal(this);
  }
