...
public class SppLambdaCaptureItemNamedImpl extends ASTWrapperPsiElement implements SppLambdaCaptureItemNamed {

  public SppLambdaCaptureItemNamedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitLambdaCaptureItemNamed(this);
  }
