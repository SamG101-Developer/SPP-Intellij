...
public class SppGenericParameterRequiredImpl extends ASTWrapperPsiElement implements SppGenericParameterRequired {

  public SppGenericParameterRequiredImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitGenericParameterRequired(this);
  }
