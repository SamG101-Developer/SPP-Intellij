...
public class SppLetStatementImpl extends ASTWrapperPsiElement implements SppLetStatement {

  public SppLetStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SppLetStatementUninitialized getLetStatementUninitialized() {
    return findChildByClass(SppLetStatementUninitialized.class);
  }
