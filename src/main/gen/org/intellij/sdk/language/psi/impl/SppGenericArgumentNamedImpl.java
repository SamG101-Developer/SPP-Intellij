...
public class SppGenericArgumentNamedImpl extends ASTWrapperPsiElement implements SppGenericArgumentNamed {

  public SppGenericArgumentNamedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitGenericArgumentNamed(this);
  }
