...
public class SppFunctionParameterVariadicImpl extends ASTWrapperPsiElement implements SppFunctionParameterVariadic {

  public SppFunctionParameterVariadicImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitFunctionParameterVariadic(this);
  }
