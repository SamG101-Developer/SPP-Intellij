...
public class SppLocalVariableSingleImpl extends ASTWrapperPsiElement implements SppLocalVariableSingle {

  public SppLocalVariableSingleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitLocalVariableSingle(this);
  }
