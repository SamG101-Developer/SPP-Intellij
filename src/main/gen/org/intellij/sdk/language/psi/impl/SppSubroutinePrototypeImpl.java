...
public class SppSubroutinePrototypeImpl extends ASTWrapperPsiElement implements SppSubroutinePrototype {

  public SppSubroutinePrototypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitSubroutinePrototype(this);
  }
