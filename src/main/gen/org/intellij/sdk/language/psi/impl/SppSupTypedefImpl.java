...
public class SppSupTypedefImpl extends ASTWrapperPsiElement implements SppSupTypedef {

  public SppSupTypedefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitSupTypedef(this);
  }
  ...
  public SppTypedefStatement getTypedefStatement() {
    return findNotNullChildByClass(SppTypedefStatement.class);
  }
