...
public class SppWhereBlockConstraintsImpl extends ASTWrapperPsiElement implements SppWhereBlockConstraints {

  public SppWhereBlockConstraintsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitWhereBlockConstraints(this);
  }
