...
public class SppGenericInlineConstraintsImpl extends ASTWrapperPsiElement implements SppGenericInlineConstraints {

  public SppGenericInlineConstraintsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitGenericInlineConstraints(this);
  }
