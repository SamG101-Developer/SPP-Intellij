...
public class SppLetStatementUninitializedImpl extends ASTWrapperPsiElement implements SppLetStatementUninitialized {

  public SppLetStatementUninitializedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitLetStatementUninitialized(this);
  }
