...
public class SppPatternVariantVariableImpl extends ASTWrapperPsiElement implements SppPatternVariantVariable {

  public SppPatternVariantVariableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitPatternVariantVariable(this);
  }
