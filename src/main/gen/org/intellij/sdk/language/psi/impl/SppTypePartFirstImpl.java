...
public class SppTypePartFirstImpl extends ASTWrapperPsiElement implements SppTypePartFirst {

  public SppTypePartFirstImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitTypePartFirst(this);
  }
  ...
  @Override
  @Nullable
  public SppSelfType getSelfType() {
    return findChildByClass(SppSelfType.class);
  }
