...
public class SppLiteralNumberBase10IntegerImpl extends ASTWrapperPsiElement implements SppLiteralNumberBase10Integer {

  public SppLiteralNumberBase10IntegerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitLiteralNumberBase10Integer(this);
  }
  ...
  public PsiElement getLxDecInteger() {
    return findNotNullChildByType(LXDECINTEGER);
  }
