...
public class SppLambdaCaptureItemNormalImpl extends ASTWrapperPsiElement implements SppLambdaCaptureItemNormal {

  public SppLambdaCaptureItemNormalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitLambdaCaptureItemNormal(this);
  }
