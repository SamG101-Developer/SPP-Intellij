...
public class SppYieldExpressionImpl extends ASTWrapperPsiElement implements SppYieldExpression {

  public SppYieldExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SppConvention getConvention() {
    return findChildByClass(SppConvention.class);
  }
