...
public class SppTypeUnionImpl extends ASTWrapperPsiElement implements SppTypeUnion {

  public SppTypeUnionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SppTypeNonUnion getTypeNonUnion() {
    return findNotNullChildByClass(SppTypeNonUnion.class);
  }
