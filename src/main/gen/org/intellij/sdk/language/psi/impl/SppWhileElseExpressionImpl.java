...
public class SppWhileElseExpressionImpl extends ASTWrapperPsiElement implements SppWhileElseExpression {

  public SppWhileElseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SppVisitor visitor) {
    visitor.visitWhileElseExpression(this);
  }
